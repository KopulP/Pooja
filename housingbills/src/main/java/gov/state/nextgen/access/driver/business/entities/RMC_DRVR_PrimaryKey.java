...
/**
 * This java bean contains the primary keys for the table RMC_DRVR
 *
 * @author CodeGenerator - Architecture Team
 * Creation Date Tue Jan 30 09:45:51 CST 2007 Modified By: Modified on: PCR#
 */
public class RMC_DRVR_PrimaryKey implements java.io.Serializable, IPrimaryKey {
	...
	public String inspectPrimaryKey() {
		return new StringBuilder().append("RMC_DRVR: ").append("app_num=").append(app_num).toString();
	}
	...
	public boolean equals(final Object obj) {
		...
		final RMC_DRVR_PrimaryKey other = (RMC_DRVR_PrimaryKey) obj;
		if (app_num == null) {
