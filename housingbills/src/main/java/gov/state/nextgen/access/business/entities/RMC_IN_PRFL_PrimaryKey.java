...
/**
 * This java bean contains the primary keys for the table RMC_IN_PRFL
 *
 * @author CodeGenerator - Architecture Team
 * Creation Date Thu Oct 11 16:06:37 CDT 2007 Modified By: Modified on: PCR#
 */
public class RMC_IN_PRFL_PrimaryKey implements java.io.Serializable, IPrimaryKey {
	...
	public String inspectPrimaryKey() {
		return new StringBuilder().append("RMC_IN_PRFL: ").append("app_num=").append(app_num).append("indv_seq_num=").append(indv_seq_num).toString();
	}
	...
	public boolean equals(final Object obj) {
		...
		final RMC_IN_PRFL_PrimaryKey other = (RMC_IN_PRFL_PrimaryKey) obj;
		if (app_num == null) {
