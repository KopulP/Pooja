...
import gov.state.nextgen.access.driver.data.db2.base.Abstract_PE_CHLD_DRVR_DAO;
...
/**
 * Data Access Object for PE_CHLD_DRVR
 *
 * @author CodeGenerator - Architecture Team
 * Creation Date Thu Jul 26 15:18:54 CDT 2007
 */
public class PE_CHLD_DRVR_DAO extends Abstract_PE_CHLD_DRVR_DAO {
	// Driver Table Update
	public boolean updateAPCDriverTable(final ICargo aCargo, final Connection aConn) {
		...
		try {
			...
			sbf.append("UPDATE " + getDBSchema() + ".PE_CHLD_DRVR SET ");
			...
			fe.setMethodID("updateAPCDriverTable");
			...
			fe.setServiceMethod("updateAPCDriverTable");
			throw fe;
