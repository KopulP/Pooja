...
@Embeddable
public class AppInIrwePrimaryKey implements Serializable, IPrimaryKey{
	...
	public String inspectPrimaryKey() {
		return new StringBuilder().append("APP_IN_IRWE: ").append("app_num=").append(app_num).append("indv_seq_num=").append(indv_seq_num)
	...
	public boolean equals(final Object obj) {
		...
		final AppInIrwePrimaryKey other = (AppInIrwePrimaryKey) obj;
		if (app_num == null) {
