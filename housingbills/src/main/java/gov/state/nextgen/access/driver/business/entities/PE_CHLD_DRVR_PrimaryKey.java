...
/**
 * This java bean contains the primary keys for the table PE_CHLD_DRVR
 *
 * @author CodeGenerator - Architecture Team
 * Creation Date Thu Jul 26 15:18:54 CDT 2007 Modified By: Modified on: PCR#
 */
public class PE_CHLD_DRVR_PrimaryKey implements java.io.Serializable, IPrimaryKey {
	...
	public String inspectPrimaryKey() {
		return new StringBuilder().append("PE_CHLD_DRVR: ").append("app_num=").append(app_num).toString();
	}
	...
	public boolean equals(final Object obj) {
		...
		final PE_CHLD_DRVR_PrimaryKey other = (PE_CHLD_DRVR_PrimaryKey) obj;
		if (app_num == null) {
