...
/**
 * This java bean contains the primary keys for the table APP_IN_SPRT_OBLG
 *
 * @author CodeGenerator - Architecture Team
 * Creation Date Aug 26 15:58:45 CDT 2009 Modified By: Modified on: PCR#
 */
@Embeddable
public class APP_IN_SPRT_OBLG_PrimaryKey implements Serializable, IPrimaryKey {
	...
	public String inspectPrimaryKey() {
		return new StringBuilder().append("APP_IN_SPRT_OBLG: ").append("app_num=").append(app_num).append("indv_seq_num=").append(indv_seq_num)
	...
	public boolean equals(final Object obj) {
		...
		final APP_IN_SPRT_OBLG_PrimaryKey other = (APP_IN_SPRT_OBLG_PrimaryKey) obj;
		if (app_num == null) {
